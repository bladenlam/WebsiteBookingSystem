...
function OnPackageChange()
{
    ...
    else if (PackageType == "Wargame")
    {
       //Set Activity Type
        ...
        //Set Number of People
        document.querySelector("#NumOfPpl").value = "6";
        OnNumPeopleChange();
        ...
        if (DiscountTotal != -45)
        {
            ...
            {
                RemoveRow(DiscountRow);
                DiscountRow = CreateRow("Package Discount", " ", " ", "$45", "$45");
            }
            else
            {
                DiscountRow = CreateRow("Package Discount", " ", " ", "$45", "$45");
    ...
    else if (PackageType == "TheRiot")
    {
        ...
        if (DiscountTotal != -60)
        {
            ...
            {
                RemoveRow(DiscountRow);
                DiscountRow = CreateRow("Package Discount", " ", " ", "$60", "$60");
            }
            else
            {
                DiscountRow = CreateRow("Package Discount", " ", " ", "$60", "$60");
